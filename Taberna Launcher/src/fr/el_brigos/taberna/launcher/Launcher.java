...
public class Launcher {
	...
	public static final GameInfos TA_INFOS = new GameInfos("Taberna", TA_VERSION, new GameTweak[] {GameTweak.FORGE});
	...
	public static void update() throws Exception {
		SUpdate su = new SUpdate("http://el-taberna.com/taberna-launcher", TA_DIR);
